...
public class GenericMinHeap<T extends Comparable<T>> {
	...
	/**
	 * Describes a Minimum Heap of general elements of general type T.
	 * This data structure allows to pop the minimal value at every given moment.
	 * 
	 * This implementation of Minimum Heap uses ArrayList as the core of the
	 ...
	 * 
	 * 		-	{@link #remove()}	Removes and returns the mininmal element
     ...
     */
    private final T minimalElement = null;
    
    // Constructor
    public GenericMinHeap() {
        Heap.add(minimalElement);
    }
     ...
     * @return whether 'element' is the new head of the heap (hence, the minimal element)
     */
